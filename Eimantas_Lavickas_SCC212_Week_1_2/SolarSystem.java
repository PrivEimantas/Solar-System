...
public class SolarSystem extends JFrame 
{
	...
	private int width = 300; // width of screen
	
	private int height = 300; // height of screen
    private boolean exiting = false; // if exit
    private Map<RenderingHints.Key, Object> renderingHints; // hints
	/*
	 * width of screen, height of screen, exiting if true or not, hints
	 */
